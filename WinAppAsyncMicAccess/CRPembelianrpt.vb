...
Public Class CRPembelianrpt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WinAppAsyncMicAccess.CRPembelianrpt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRPembelianrpt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRPembelianrpt = New CRPembelianrpt()
        rpt.Site = Me.Site
        Return rpt
    End Function
